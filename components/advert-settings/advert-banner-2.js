  ...
  const updateImage = async () => {
    ...
    try {
      ...
      await updateDoc(bannerDoc, {
        banner_2: { logo: logoURL, link: link },
      });
    } catch (err) {
      console.log(err);
  ...
  return (
    <>
      <div className="bg-base-300 p-5 rounded-lg card">
        ...
        <p className="my-2">
          Advert Banner 2 : This Image should be 1800px X 120px and not exceed
          1MB
          <br />
...
export default AdvertBannerTwo;
