  ...
  const updateImage = async () => {
    ...
    try {
      ...
      await updateDoc(bannerDoc, {
        banner_6: { logo: logoURL, link: link },
      });
    } catch (err) {
      console.log(err);
  ...
  return (
    <>
      <div className="bg-base-300 p-5 rounded-lg card">
        ...
        <p className="my-2">
          Advert Banner 6: This Image should be 300px X 100px and not exceed
          1MB
          <br />
...
export default AdvertBannerSix;
